...
require('lazy').setup({
  ...
  'bogado/file-line',
  --  matchit.zip was previously disabled on 2020-10-03,
  -- 'matchit.zip',
  ...
  'mileszs/ack.vim',
  'rking/ag.vim',
  'JazzCore/ctrlp-cmatcher', -- {'do': './install.sh'},
